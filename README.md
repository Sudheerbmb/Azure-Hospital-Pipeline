...
The pipeline ingests streaming data, processes it in **Databricks (PySpark)**, and stores it in **Azure Synapse SQL Pool** 
...
- **Portfolio Value:** Demonstrates both **Data Engineering** project.  
